...
#python efl_train.py --train_file ratings_train.csv --validation_file ratings_test.csv --task_dataset nsmc \
...
# Description 1로 변경하고 tbert-base 기본 모델 사용하고 epoch 20 | rdrop 5
#python efl_train.py --train_file ratings_train.csv --validation_file ratings_test.csv --task_dataset nsmc \
#--model_name_or_path model/tbert_1.9 --vocab_path tokenizer/version_1.9 \
#--output_dir finetuning/tbert-base/nsmc/efl-desc1-rdrop_5-patience_5 --num_train_epochs 20 \
#--checkpointing_steps 1000 --gradient_accumulation_steps 1 --pad_to_max_length --with_tracking --report_to wandb \
#--run_name tbert-base-nsmc-efl-desc1-rdrop_5-patience_5 --entity raki-1203 --seed 42 --learning_rate 1e-5 \
#--lr_scheduler_type ReduceLROnPlateau --patience 5 --rdrop_coef 5

# Description 1로 변경하고 tbert-base 기본 모델 사용하고 epoch 10 | rdrop 3
python efl_train.py --train_file ratings_train.csv --validation_file ratings_test.csv --task_dataset nsmc \
--model_name_or_path model/tbert_1.9 --vocab_path tokenizer/version_1.9 \
--output_dir finetuning/tbert-base/nsmc/efl-desc1-rdrop_3-patience_5 --num_train_epochs 10 \
