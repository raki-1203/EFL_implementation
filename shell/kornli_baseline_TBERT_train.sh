...
#python train.py --train_file snli_1.0_train.ko.csv --validation_file xnli.dev.ko.csv --test_file xnli.test.ko.csv \
#--model_name_or_path model/tbert_1.9 --vocab_path tokenizer/version_1.9 --output_dir finetuning/tbert-base/kornli/original \
